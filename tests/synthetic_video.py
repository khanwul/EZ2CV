...
def make_fixture(path: Path, alignment_offset=(0, 0),
    ...
    config = RunConfig(
        ...
        note_height=NOTE_HEIGHT, note_width=30,
        trigger_template_y_top=TRIGGER, tail_release_offset_px=0,
        key_count=2, lanes=lanes, tail_search_y_max=TRIGGER,
        beat_roi=(10, 10, 20, 20), beat_channel="gray",
        beat_diff_threshold=10.0,
        measure_line=MeasureLineConfig(20.0, 130.0, 3, 0, 50.0),
        pixels_per_frame=SPEED, min_longnote_px=10,
